            ...
            <div class="section dwo">
                <div class="container">
                    <div class="row full-height justify-content-center">
                        <div class="col-12 text-center align-self-center py-5" style="display:flex; justify-content: center; align-items: center; transform: translateY(50px)">
                                            ...
                                            <div class="center-wrap">
                                                <div class="section text-center">
                                                    ...
                                                    <div class="form-group mt-2">
                                                        <input type="text" style="width: 50%; float: left" name="logcheck" class="form-style" placeholder="请输入验证码" id="logcheck" autocomplete="off" v-model="code">
                                                        <i class="fa fa-unlock-alt" aria-hidden="true"></i>
                                                        <el-button type="primary" style="width: 45%;height: 48px; margin-top: 0px" @click="getCaptcha">
                                                            获取验证码
                                                        </el-button>
                                                    </div>
    ...
    methods: {
        async handleChangeCheckCode() {
            ...
            const { data: res } = await service({
                url: `/user/randomImage/${this.currdatetime}`,
                method: "get",
            });
            // const { data: res } = await api.get(
            //     `/user/user/randomImage/${this.currdatetime}`
            // );
            if (res.flag === true) {
        ...
        async register() {
            ...
            // const { data: res } = await api.post("/user/register", {
            //     email: this.mail,
            //     code: this.code,
            //     password: this.password,
            //     username: this.username,
