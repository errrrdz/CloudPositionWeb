package position.web.cty.rabbitmq.client;


import position.web.cty.annotation.RabbitComponent;
import position.web.cty.rabbitmq.event.CtyRemoteApplicationEvent;
...
import position.web.cty.rabbitmq.event.EventObj;
import position.web.cty.rabbitmq.exchange.DelayExchangeBuilder;
...
public class RabbitMqClient {
    ...
    public void publishEvent(String handlerName, BaseMap baseMap) {
        ...
        publisher.publishEvent(new CtyRemoteApplicationEvent(eventObj, busProperties.getId()));
    }
