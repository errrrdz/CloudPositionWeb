...
import position.web.exception.PositionException;
...
public class JwtUtil {
    ...
    public static void responseError(ServletResponse response, Integer code, String errorMsg) {
        ...
        Result jsonResult = new Result(false, code, errorMsg);
	 ...
	 */
	public static Long getIdByToken(HttpServletRequest request) throws PositionException {
		String accessToken = request.getHeader("X-Access-Token");
		Long id = getId(accessToken);
		if (oConvertUtils.isEmpty(id)) {
			throw new PositionException("未获取到用户");
		}
		return id;
	}
